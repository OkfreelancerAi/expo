...
// MongoDB connection
mongoose.connect('mongodb://localhost:27017/adultApp', {
...
app.get('/content', authenticate, (req, res) => {
  // Example content retrieval logic
  res.send([
    { id: 1, title: 'Premium Video', category: 'Anal' },
    { id: 2, title: 'Exclusive Content', category: 'MILF' },
  ]);
});
